...
// let lowerCaseList = filterList.map(item => items.toLowerCase());
// console.log(lowerCaseList);


// SIMILAR TO HOMEWORK (recipes pt. 2)
...
let sorterHikes = filteredHikes.sort(compareHikes);
console.log(sorterHikes);
